...
class MeditationAndWisdom extends StatefulWidget {
  ...
  @override
  State<MeditationAndWisdom> createState() => _MeditationAndWisdomState();
}

class _MeditationAndWisdomState extends State<MeditationAndWisdom> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Meditation & Wisdom'),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: Text(
                  'Nourish your soul with guided practices',
                  style: TextStyle(
                    fontSize: 14.sp,
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Color(0xffEEAAFF),
