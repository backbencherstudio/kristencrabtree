  ...
  Widget build(BuildContext context) {
    ...
    return CustomCardBase(
      child: Column(
        ...
        children: [
          Text(
            'Layer ${provider.completedSteps + 1}: Reflect',
          ...
          CustomCardBase(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Make a quick journal entry about this Dig.',
                  style: TextStyle(
                    fontSize: 15.sp,
          ...
          PrimaryButton(
            onTap: () {
              context.read<EmotionalBodyExcavationScreenProvider>().incrementCompletedDigs();
